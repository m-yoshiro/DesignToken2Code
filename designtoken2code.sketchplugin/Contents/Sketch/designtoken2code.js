...
function __skpm_run(key, context) {
        ...
        /***/ function(module, exports) {
          ...
          module.exports.createDialog = function(_ref) {
            ...
            if (contentText) {
              ...
              var radioButton1 = NSButton.alloc().initWithFrame(
                NSMakeRect(0, 0, 300, 18)
              )
              radioButton1.setButtonType(NSRadioButton)
              radioButton1.setTitle('First')
              radioButton1.setState(true) // Insert contentText

              theTextView.setString(contentText)
              theTextView.editable = false // Put contentText into scrollView
  ...
  \**********************/
        ...
        /***/ function(module, exports) {
           ...
           */
          module.exports.escapeRegExp = function(pattern) {
